...
export default function EditBrand({ brand }) {
    ...
    function clearForm() {
      ...
      function submitHandler(event) {
        ...
        axiosAPIinstance.put(`/brand/update/${brand._id}`, data)
          .then((response) => {
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
            ...
            <div className="w-full max-w-xl bg-white shadow-lg rounded-xl p-8">
              ...
              file:bg-orange-50 file:text-orange-600 hover:file:bg-orange-100"
                        />
                        <img
                            className="w-[35px] h-[30px] rounded-md object-cover"
                            src={process.env.NEXT_PUBLIC_BRAND_IMAGE_URL + brand.image}
                            alt={brand.name}
                        />
                    </div>
